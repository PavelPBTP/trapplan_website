...
const translations: Partial<Record<CopyKey, string>> = {
    ...
    "ui.pagination.page_aria": "Vai alla pagina {n}",
    "ui.mobile_cta.label": "Richiedi un preventivo",
    "ui.cookie.title": "Usiamo i cookie.",
    "ui.cookie.body": "Un set minimo di cookie mantiene il sito funzionante. Con il tuo consenso, analisi anonime ci aiutano a capire quali guide aiutano davvero gli studi. Nessun tracker di terze parti si attiva finché non accetti.",
    "ui.cookie.accept": "Accetta tutto",
    "ui.cookie.reject": "Rifiuta non essenziali",
    "ui.cookie.learn_more": "Scopri di più",
    "ui.breadcrumb.home": "Home",
    "ui.breadcrumb.blog": "Blog",
    "ui.breadcrumb.our_cases": "Casi studio",
    "ui.breadcrumb.about": "Chi siamo",
    "services_hub.title": "Tutto ciò che facciamo per gli studi di gioco.",
    "services_hub.subtitle": "Scegli il servizio di cui hai bisogno oggi, o combinane diversi in un progetto completo. Tutto gestito dallo stesso team senior che pubblica giochi.",
