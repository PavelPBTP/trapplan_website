...
const translations: Partial<Record<CopyKey, string>> = {
    ...
    "form.get_a_quote.field_goals": "Tell us about your game",
    "form.get_a_quote.email_invalid": "Please enter a valid email",
    "form.get_a_quote.spam_note": "We reply within one business day. No spam, ever.",
    "ui.newsletter.title": "Stay in the loop",
    "ui.newsletter.placeholder": "you@studio.com",
    "ui.newsletter.submit": "Subscribe",
    "ui.newsletter.success": "Thanks — you're on the list.",
    "ui.newsletter.error": "Please enter a valid email.",
    "ui.newsletter.privacy_note": "Monthly tactics for game marketers. Unsubscribe anytime.",
